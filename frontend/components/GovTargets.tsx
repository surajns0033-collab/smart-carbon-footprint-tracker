    ...
    <div className="space-y-6 animate-fade-in text-gray-900 dark:text-gray-100">
      <div className="flex justify-between items-center gap-3 mb-6 bg-white/80 dark:bg-gray-900/80 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm backdrop-blur-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-850 dark:text-gray-100">
        ...
        <button 
          ...
          className="p-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl border border-gray-250 dark:border-gray-700 text-gray-650 dark:text-gray-305 transition-colors cursor-pointer"
      ...
      <div className="flex gap-2 overflow-x-auto pb-2 border-b border-gray-250 dark:border-gray-800 scrollbar-hide">
          ...
          <button 
            ...
            className={`px-4 py-2 font-semibold whitespace-nowrap transition-colors cursor-pointer text-sm ${
              activeTab === tabId 
                ...
                : 'text-gray-500 dark:text-gray-400 hover:text-gray-805 dark:hover:text-gray-200'
            }`}
          >
      ...
      {activeTab === 'national' && (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden backdrop-blur-md">
              ...
              <div className="space-y-2">
                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-gray-250 dark:bg-gray-800 rounded-full h-2.5"><div className="bg-eco-500 h-2.5 rounded-full" style={{ width: `${Math.min(100, Math.max(5, progressPct))}%` }}></div></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden backdrop-blur-md">
              ...
              <div className="space-y-4 mt-8">
                 <div>
                  ...
                  <div className="w-full bg-gray-250 dark:bg-gray-800 rounded-full h-2.5"><div className="bg-blue-500 h-2.5 rounded-full" style={{ width: `${targetData.currentRenewablePct}%` }}></div></div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white/80 dark:bg-gray-900/80 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 backdrop-blur-md">
            <h3 className="font-bold text-gray-850 dark:text-gray-100 mb-2">📄 Official Climate Commitment Summary</h3>
              ...
              <button 
                ...
                className={`px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap transition-colors cursor-pointer ${
                  selectedSector === s 
                    ...
                    : 'bg-gray-150 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700'
                }`}
              >
                {s}
              </button>
